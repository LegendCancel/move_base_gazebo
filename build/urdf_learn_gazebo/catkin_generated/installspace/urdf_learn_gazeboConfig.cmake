...
if(urdf_learn_gazebo_CONFIG_INCLUDED)
  return()
endif()
set(urdf_learn_gazebo_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(urdf_learn_gazebo_SOURCE_PREFIX /home/lc/urdf_ws/src/urdf_learn_gazebo)
  set(urdf_learn_gazebo_DEVEL_PREFIX /home/lc/urdf_ws/devel)
  set(urdf_learn_gazebo_INSTALL_PREFIX "")
  set(urdf_learn_gazebo_PREFIX ${urdf_learn_gazebo_DEVEL_PREFIX})
else()
  set(urdf_learn_gazebo_SOURCE_PREFIX "")
  set(urdf_learn_gazebo_DEVEL_PREFIX "")
  set(urdf_learn_gazebo_INSTALL_PREFIX /home/lc/urdf_ws/install)
  set(urdf_learn_gazebo_PREFIX ${urdf_learn_gazebo_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'urdf_learn_gazebo' is deprecated")
...
set(urdf_learn_gazebo_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(urdf_learn_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${urdf_learn_gazebo_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'urdf_learn_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'urdf_learn_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(urdf_learn_gazebo_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND urdf_learn_gazebo_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND urdf_learn_gazebo_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT urdf_learn_gazebo_NUM_DUMMY_TARGETS)
      set(urdf_learn_gazebo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::urdf_learn_gazebo::wrapped-linker-option${urdf_learn_gazebo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR urdf_learn_gazebo_NUM_DUMMY_TARGETS "${urdf_learn_gazebo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::urdf_learn_gazebo::wrapped-linker-option${urdf_learn_gazebo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND urdf_learn_gazebo_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(urdf_learn_gazebo_LIBRARY_DIRS ${lib_path})
      list(APPEND urdf_learn_gazebo_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'urdf_learn_gazebo'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND urdf_learn_gazebo_LIBRARIES ${lib})
    endif()
  endif()
...
set(urdf_learn_gazebo_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${urdf_learn_gazebo_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 urdf_learn_gazebo_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${urdf_learn_gazebo_dep}_FOUND)
      find_package(${urdf_learn_gazebo_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${urdf_learn_gazebo_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(urdf_learn_gazebo_INCLUDE_DIRS ${${urdf_learn_gazebo_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(urdf_learn_gazebo_LIBRARIES ${urdf_learn_gazebo_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${urdf_learn_gazebo_dep}_LIBRARIES})
  _list_append_deduplicate(urdf_learn_gazebo_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(urdf_learn_gazebo_LIBRARIES ${urdf_learn_gazebo_LIBRARIES})

  _list_append_unique(urdf_learn_gazebo_LIBRARY_DIRS ${${urdf_learn_gazebo_dep}_LIBRARY_DIRS})
  list(APPEND urdf_learn_gazebo_EXPORTED_TARGETS ${${urdf_learn_gazebo_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${urdf_learn_gazebo_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
